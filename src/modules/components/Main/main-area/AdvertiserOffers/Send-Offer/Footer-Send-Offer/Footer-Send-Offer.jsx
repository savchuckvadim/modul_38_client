...
import footer from './Footer-Send-Offer.module.css'
const FooterSendOffer = (props) => {
    let height = 0
    let heightCamera = 0
    let opacity = 0
    let opacityCamera = 0
        ...
        >
            ...
            <div className={style.right__area}
                ...
                <div
                    ...
                    <RedButton className={cameraClass}  border={12} name={'Send Offer'} />
                </div>
            </div>
        </div>
    )
...
export default FooterSendOffer